        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary card-outline">
            <div class="card-header">
              <h3 class="card-title"><i class="fa fa-building mr-3"></i><b>Edit Instansi</b></h3>
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-12 mt-3">
                  ...
                  <form action="{{ route('posteditinstansi')}}" method="post" class="form-horizontal">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        ...
                        <input type="text" name="name" id="nama" class="form-control" value="{{ $instansi-> name}}" required autofocus>
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-9">
                        <textarea name="address" id="alamat" cols="30" rows="2" class="form-control">{{ $instansi->addr }}</textarea>
                      </div>
                    </div>
